...
void OLED_ShowBigCN(unsigned char x, unsigned char y, unsigned char N)
{
    unsigned char wm = 0;
...
void OLED_ShowBigNb(unsigned char x, unsigned char y, unsigned char N)
{
    unsigned char wm = 0;
